"""
URL configuration for LR1 project.
...
urlpatterns = [
    ...
    path('cart/remove/<int:cart_product_id>/', views.remove_from_cart, name='remove_from_cart'),
    ...
    path('jokes/', views.main_info, name='jokes'),
